...
public class Config {
    public static final String STAGE_CARD_DURATION = "STAGE_CARD_DURATION";
    ...
    private static final float DEFAULT_CARD_TURN_DURATION = 30f;
    private static final float DEFAULT_CARD_STEP_DURATION = 1f;
    private static final float DEFAULT_CARD_STEP_DELAY = 1f;
    private static final float DEFAULT_CARD_DELAY = 2f;
    ...
    public Config() {
        mDefaultValues.put(STAGE_CARD_DURATION, 30f);
