...
public class PlayerToken extends olof.sjoholm.game.server.objects.GameBoardActor {
    ...
    private static class MoveDirectionAction extends RelativeAction {
        private final olof.sjoholm.game.server.objects.GameBoardActor actor;
        private final Movement movement;
        private final float speed;
        private Action moveByAction;

        public MoveDirectionAction(olof.sjoholm.game.server.objects.GameBoardActor actor, Movement movement, float speed) {
            this.actor = actor;
            this.movement = movement;
            this.speed = speed;
        }
